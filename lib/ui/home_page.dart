...
import 'package:weather_app2/components/weather_item.dart';
import 'dart:ui';
import 'package:weather_app2/constants.dart';
import 'package:flutter/services.dart';
import 'package:intl/intl.dart';
import 'package:modal_bottom_sheet/modal_bottom_sheet.dart';
import 'package:weather_app2/ui/detail_page.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  static String API_KEY = '73a36cfc40d842d7851170424221910';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Container(
        width: size.width,
        height: size.height,
        padding: const EdgeInsets.only(top: 35, left: 10, right: 10, bottom: 0),
